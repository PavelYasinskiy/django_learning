...
# Добавьте модель для хранения рубрики объявления
# (Возможные значения: Авто, Недвижимость, Работа), поля: наименование.
#
...
#
#
# При нажатии на заголовок должен произойти переход на детальную страницу объявления
# , на которой должны быть представлены следующие данные:
#
# Заголовок
# Цена
# Описание
...
#
# По умолчанию цена должна отображаться в рублях,
# рядом можно разместить цену в долларах по курсу ЦБ.